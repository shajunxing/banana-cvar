...
|void aforeach(struct var *arr, void (*cb)(size_t i, struct var *v, void *xargs), void *xargs)|for (i, v in arr) {...}|顺序遍历数组所有索引和值|
...
|void oforeach(struct var *obj, void (*cb)(const char *k, size_t klen, struct var *v, void *xargs), void *xargs)|for (k, klen, v in obj) {...}|遍历对象所有键和值|
